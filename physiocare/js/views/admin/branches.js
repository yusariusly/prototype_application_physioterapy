        ...
        const branchCards = branches.map(b => `
            <div class="bg-clinical-white rounded-3xl p-6 shadow-clinical border border-outline-variant/20 hover:border-primary/30 transition-all flex flex-col">
                <div class="flex justify-between items-start mb-6">
                    ...
                    <span class="bg-success-green/10 text-success-green text-[11px] font-bold px-2 py-0.5 rounded-full border border-success-green/20">ACTIVE</span>
                </div>
                <div class="space-y-3 mb-6">
                    ...
                    <div class="flex gap-3">
                        ...
                        <p class="text-sm text-on-surface-variant">${b.therapists} Terapis</p>
                    </div>
                </div>
        ...
        <main class="ml-64 min-h-screen">
            <header class="sticky top-0 z-40 h-16 px-8 bg-clinical-white border-b border-outline-variant flex justify-between items-center shadow-sm">
                ...
                <div class="flex items-center gap-4">
                    <div class="relative">
                        ...
                        <input class="pl-10 pr-4 py-2 bg-surface-muted border-none rounded-full text-body-md focus:ring-2 focus:ring-secondary w-64" placeholder="Search branches..." type="text">
                    </div>
            ...
            <div class="p-8 max-w-[1400px] mx-auto">
                <div class="flex justify-between items-end mb-8">
                    <div>
                        <h2 class="font-headline-lg text-headline-lg text-on-surface mb-2">Manajemen Cabang</h2>
                        <p class="text-on-surface-variant max-w-2xl">Kelola seluruh cabang klinik PhysioCare, pantau kapasitas, dan koordinasikan penjadwalan terapis.</p>
                    </div>
